...
`executor` and `autonomyLevel` remain the underlying schema fields (unchanged); Control Mode is a UI-only classification layered on top — see [ADR-0014](docs/adr/0014-control-mode-ui-concept.md).
