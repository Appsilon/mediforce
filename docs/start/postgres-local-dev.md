...
layer, and authentication moved off Firebase to NextAuth (ADR-0002). These are the devloop notes for
...
[PLAN-0001 §8.5](../archive/PLAN-0001.md#85-ongoing-migrations).
...
[PLAN-0001 §10.1](../archive/PLAN-0001.md#101-migration-filename-rule) for the
