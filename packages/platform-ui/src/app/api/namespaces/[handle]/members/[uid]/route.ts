...
import type { RemoveNamespaceMemberInput, UpdateNamespaceMemberRoleInput } from '@mediforce/platform-api/contract';
import { removeNamespaceMember, updateNamespaceMemberRole } from '@mediforce/platform-api/handlers';
