 ...
 * will not resolve on their own. Retrying them wastes API requests and DB load
 * and hides the real error from the UI. Stop immediately; let 5xx/network errors
