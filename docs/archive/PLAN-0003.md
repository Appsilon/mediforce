...
Companion to [`0003-remove-firebase-storage.md`](../adr/0003-remove-firebase-storage.md).
...
repository base from [ADR-0004](../adr/0004-scoped-data-access-authorization.md) is
...
- `packages/platform-infra/src/storage/filesystem-blob-store.ts` —
  ...
  volume ADR-0015 uses for bare repos); attachments under
...
$callerWorkspaces` gated per [ADR-0004](../adr/0004-scoped-data-access-authorization.md).
