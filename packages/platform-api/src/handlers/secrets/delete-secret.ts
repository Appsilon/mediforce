...
import type { DeleteSecretInput, DeleteSecretOutput } from '../../contract/secrets';
 ...
 */
export async function deleteSecret(input: DeleteSecretInput, scope: CallerScope): Promise<DeleteSecretOutput> {
