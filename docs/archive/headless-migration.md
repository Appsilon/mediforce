...
- [`docs/testing/engine-testing.md`](../testing/engine-testing.md) — the Contract test layer that anchors this migration
...
- Decisions crystallised in `docs/archive/headless-migration.md` + (likely) `docs/decisions/ADR-003-authorization-architecture.md`.
...
code-architecture concepts in [`api-architecture.md`](../reference/api-architecture.md).
