...
import { ListRunNamesInputSchema, type ListRunNamesInput } from '@mediforce/platform-api/contract';
 ...
 */
export const GET = createRouteAdapter<typeof ListRunNamesInputSchema, ListRunNamesInput>(
