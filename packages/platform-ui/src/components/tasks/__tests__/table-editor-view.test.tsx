  ...
  const items = overrides.items ?? [
    {
      ...
      badges: ['bug'],
      href: 'https://gh/101',
      suggestion: { category: 'ux', priority: 'P1' },
    },
    {
      id: '102',
      label: '#102 Add CSV export',
      badges: ['enhancement', 'ux'],
      suggestion: { category: 'tech-debt', priority: 'P3' },
    },
  ];
...
describe('TableEditorView', () => {
  ...
  it('[RENDER] single-select lists all configured options', () => {
    ...
    const labels = within(categorySelects[0])
      .getAllByRole('option')
      .map((o) => o.textContent);
    ...
    render(
      <TableEditorView
        task={buildTableEditorTask({
          status: 'completed',
          completionData: {
            rows: [{ itemId: '1001', values: { category: 'ux', priority: 'P0' } }],
            completedBy: 'user-1',
