...
<body style="margin:0;padding:0;background:#f4f4f5;font-family:-apple-system,BlinkMacSystemFont,'Segoe UI',Roboto,sans-serif">
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="max-width:520px">
        ...
        <tr><td style="background:#ffffff;padding:32px">
          ...
          <p style="margin:0 0 28px;font-size:15px;color:#71717a;line-height:1.5">
            <strong style="color:#09090b">${params.inviterName}</strong> has invited you to the
            <strong style="color:#09090b">${params.workspaceName}</strong> workspace on ${params.senderName}.
          </p>

          <a href="${params.workspaceUrl}" style="display:block;text-align:center;background:#1c8879;color:#ffffff;padding:12px 24px;border-radius:6px;text-decoration:none;font-size:14px;font-weight:500">
            Open workspace
          </a>
        </td></tr>
  ...
  formData.append('subject', `You've been invited to ${params.workspaceName} on ${params.senderName}`);
