...
This isn't a product announcement. We don't have a polished landing page or a sales deck. What we have is a clear vision, working code, and the conviction that pharma needs this — now.

We're building Mediforce in the open because we believe the best way to create a standard is to create it together. We want input from people who work in clinical operations, from developers who build for regulated industries, from compliance experts who know what "GxP-ready" actually requires.
...
Mediforce is a developer platform, not a drag-and-drop builder. We believe that code is the most precise, version-controllable, and AI-friendly way to define processes. Good APIs, clear documentation, and TypeScript throughout.

That said, AI coding assistants make code-first accessible to people who think in processes, not in syntax.
...
1. **[Join our Discord](https://discord.gg/Hkb2K7YE)** and share your perspective
2. **Open an issue** describing a process you'd want to see on the platform
3. **Come to a Friday working session** (3:00 PM CEST, weekly) — ask questions, give feedback, see what we're working on

## Staying Updated

- **[Discord](https://discord.gg/Hkb2K7YE)** — real-time conversations and progress updates
- **GitHub** — star the repo, watch for updates
- **Blog** — longer-form posts on [appsilon.com/blog](https://appsilon.com/blog)
