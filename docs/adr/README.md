...
| [0002](./0002-firebase-auth-to-nextauth.md) | Move authentication from Firebase Auth to NextAuth (Auth.js v5) (+ [PLAN](../archive/PLAN-0002.md), [RUNBOOK](../archive/RUNBOOK-0002-staging-cutover.md)) | Partially superseded by [0019](./0019-workspace-scoped-roles.md) (§5, global `user_roles`) |
...
| [0021](./0021-image-catalog.md) | The Image Catalog is an image the platform offers, keyed on its source | Proposed |
