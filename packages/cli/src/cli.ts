...
import {
  ...
  evalCaseRedTeamCommand,
  evalCasesFromLabelsCommand,
...
export const TREE: Record<string, BranchEntry> = {
  ...
  eval: {
    ...
    leaves: {
      ...
      'evaluator-labels': { description: 'List the labels on an Evaluator\'s outputs', fn: evalEvaluatorLabelsCommand },
