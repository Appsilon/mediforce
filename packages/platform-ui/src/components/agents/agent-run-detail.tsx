    ...
    <div className="p-6 space-y-6 max-w-3xl">
      ...
      <div className="space-y-2">
        <div className="flex items-start gap-3">
          <div className="flex-1">
            ...
            <p className="text-sm text-muted-foreground">
              {processInstance?.definitionName ?? 'Unknown Process'}
            </p>
          </div>
        ...
        <div className="flex flex-wrap gap-x-6 gap-y-1 text-sm text-muted-foreground">
          ...
          <span>Process: <Link href={`/processes/${run.processInstanceId}`} className="text-primary hover:underline font-mono text-xs">{run.processInstanceId.slice(0, 12)}...</Link></span>
