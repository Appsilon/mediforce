...
Do NOT hardcode product context in this skill — it drifts. If you need background on what MediForce is or who the audience is, read `README.md` (project root) and skim `docs/` (especially `docs/concepts/architecture.md`). Pull only what's needed to make the update specific and accurate.
