...
import { User, GitBranch, Bot, Activity, LogOut, Menu, X, Plus, Play, ChevronDown, Building2, Check, Radar } from 'lucide-react';
...
const NAV_ITEMS = [
  { href: '/team', label: 'Mission Control', icon: Radar, badge: null, exact: false },
