...
- **Status note:** frozen 2026-05-25 per the post-merge note below; this ADR predates the formal `Finalized` status — treat it as locked, changes via supersession only.
- **Date:** 2026-05-22
